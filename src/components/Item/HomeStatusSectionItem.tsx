...
const HomeStatusSectionItem = (props: any) => {
  const { data } = props;
  ...
  const saveItem = async () => {
    ...
    <div className="tabItem">
      <Grid container spacing={3}>
        ...
        <Grid item xs={10}>
          <div className="row">
            <TextField label="" variant="outlined" value={item.value} onChange={(e) => handleDataChange(e, 'value')} fullWidth />
          </div>
        </Grid>
      </Grid>
    </div>
...
export default HomeStatusSectionItem;
